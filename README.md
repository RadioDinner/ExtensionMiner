...
- **Analyze with Claude:** double-click `scripts\run_ranker.cmd` to run all the
  Claude tasks — ranking (mines reviews → `opportunities`) **and** monetization
  research (pricing/revenue → `monetization`). Run
